    ...
    function getSelectedOptions(select, ignoreDisabled) {
        ...
        if (ignoreDisabled) {
            for (var i = 0, len = selectedOptions.length; i < len; i++) {
                ...
                if (
                    !(opt.disabled || (opt.parentNode.tagName === "OPTGROUP" && opt.parentNode.disabled))
                ) {
                    options.push(opt);
                }
            }
    ...
    Selectpicker.prototype = {
            ...
            if (setSize) {
                if (refresh) {
                    ...
                    if (typeof selectedIndex === "number" && that.options.size !== false) {
                        ...
                        if (position) {
                            scrollTop =
                                position - (that.sizeInfo.menuInnerHeight + that.sizeInfo.liHeight) / 2;
                        }
                    }
                }
            }
            ...
            this.$menuInner.on("click", "li a", function (e, retainActive) {
                ...
                if (!that.isDisabled() && !$this.parent().hasClass(classNames.DISABLED)) {
                    var option = clickedData.option,
                        ...
                        maxOptionsGrp =
                            (optgroup && parseInt(dataGetter(optgroup, "maxOptions"))) || false;
        ...
        toggle: function (e, state) {
            ...
            if (triggerClick === false) {
                ...
                triggerClick =
                    (state === true && isActive === false) || (state === false && isActive === true);
            }
